...
|---|---:|---|
| **DISPONIBLE (2 sources)** | 310 | vervox et socialcal disent tous deux « libre » |
| DISPONIBLE (1 source) | 9 | une seule source l'a vérifié ; l'autre ne l'a pas encore fait |
| CONTRADICTION | 5 | les deux sources se contredisent — aucune n'est retenue |
| PRIS | 581 | au moins une source a trouvé le compte |
| INDÉTERMINÉ | 95 | interrogé, mais aucune réponse exploitable |
| **Total** | **1000** | |
...
## DISPONIBLE (1 source) — 9

| # | Pseudo | Vervox | SocialCal | Vérifié le |
|---|---|---|---|---|
| 508 | `m7eve` | — | available | 28/08/2026 13:12:41 |
