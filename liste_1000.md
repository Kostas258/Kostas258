...
|---|---:|---|
| **DISPONIBLE (2 sources)** | 315 | vervox et socialcal disent tous deux « libre » |
| DISPONIBLE (1 source) | 21 | une seule source l'a vérifié ; l'autre ne l'a pas encore fait |
| CONTRADICTION | 5 | les deux sources se contredisent — aucune n'est retenue |
| PRIS | 600 | au moins une source a trouvé le compte |
| INDÉTERMINÉ | 59 | interrogé, mais aucune réponse exploitable |
| **Total** | **1000** | |
...
| 842 | `m7qyq` | — | available | 28/08/2026 14:09:34 |
| 844 | `m7qyv` | — | available | 28/08/2026 14:10:35 |
| 871 | `m7xar` | — | available | 28/08/2026 14:19:44 |
