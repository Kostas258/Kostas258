...
|---|---:|---|
| **DISPONIBLE (2 sources)** | 308 | vervox et socialcal disent tous deux « libre » |
| DISPONIBLE (1 source) | 7 | une seule source l'a vérifié ; l'autre ne l'a pas encore fait |
| CONTRADICTION | 5 | les deux sources se contredisent — aucune n'est retenue |
| PRIS | 569 | au moins une source a trouvé le compte |
| INDÉTERMINÉ | 111 | interrogé, mais aucune réponse exploitable |
| **Total** | **1000** | |
...
## DISPONIBLE (1 source) — 7

| # | Pseudo | Vervox | SocialCal | Vérifié le |
|---|---|---|---|---|
| 369 | `m7iza` | — | available | 28/08/2026 12:51:19 |
